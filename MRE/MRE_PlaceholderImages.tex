...
\newcommand{\fillspacewithplaceholder}[1][84]{%
  ...
  \begin{tikzpicture}%
    ...
    \node at (0.5\columnwidth,0.5\remainingheight) 
      {Width = \the\columnwidth, Height = \the\remainingheight};%
  \end{tikzpicture}%
  \end{center}%
}
...
%\section*{Dual Column, "bad" amount of text.}
%\begin{multicols}{2}
%\lipsum[1-2]
%\fillspacewithplaceholder
%\end{multicols}
